...
- Deploying infrastructure services (PostgreSQL, optional Kafka) in `infra` namespace.
...
- `k8s/infra/`: Infra resources (DB, Kafka).
...
- Kafka is included as a simple single-replica StatefulSet for lab use.
